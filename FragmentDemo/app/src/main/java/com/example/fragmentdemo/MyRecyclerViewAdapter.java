...
public class MyRecyclerViewAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
    private List<ImageItem> mItemData;
    ...
    public MyRecyclerViewAdapter(List<ImageItem> ItemData) {
    ...
    public int getItemViewType(int position) {
        ImageItem ImageItem = mItemData.get(position);
        return ImageItem.getImgType();
    }
    ...
    public void onBindViewHolder(@NonNull final RecyclerView.ViewHolder holder, final int position) {
        if (holder instanceof MyViewHolder) {
            ImageItem ImageItem = mItemData.get(position);
            ((MyViewHolder) holder).itemIV.setImageResource(ImageItem.getImgId());
            ...
            ImageItem ImageItem = mItemData.get(position);
            ((MyBigViewHolder) holder).bigItemIV.setImageResource(ImageItem.getImgId());
            if (mOnItemClickListener != null) {
            ...
            ImageItem ImageItem = mItemData.get(position);
            final String buttonName = ImageItem.getButtonName();
            ((MyButtonViewHolder) holder).buttonItemBT.setText(ImageItem.getButtonName());
